      ...
      <header className="border-b border-border bg-card/50 backdrop-blur-xl sticky top-0 z-40">
        <div className="px-6 py-3 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground">Top performers across all props</p>
          </div>
              ...
              {ranked.map((p, i) => (
                <tr key={p.id} className="border-b border-border/50 hover:bg-secondary/30 transition-colors">
                  ...
                  <td className="text-center py-3 px-4">
                    <span className={`px-2 py-1 rounded text-xs font-semibold ${p.l5 >= 80 ? "hit-cell-high" : p.l5 >= 60 ? "hit-cell-mid" : "hit-cell-low"}`}>{p.l5}%</span>
                  </td>
                  <td className="text-center py-3 px-4">
                    <span className={`px-2 py-1 rounded text-xs font-semibold ${p.l10 >= 80 ? "hit-cell-high" : p.l10 >= 60 ? "hit-cell-mid" : "hit-cell-low"}`}>{p.l10}%</span>
                  </td>
                  <td className="text-center py-3 px-4">
                    <span className={`px-2 py-1 rounded text-xs font-semibold ${p.l15 >= 80 ? "hit-cell-high" : p.l15 >= 60 ? "hit-cell-mid" : "hit-cell-low"}`}>{p.l15}%</span>
                  </td>
                  <td className="text-center py-3 px-4">
