...
export type SortField = "line" | "confidence" | "hit_rate" | "diff" | "avg_last5" | "avg_last10" | "avg_last20";
            ...
            >
              ...
              <td className="text-center py-3 px-2">
                <span className={`px-2 py-1 rounded text-xs font-semibold ${
                  (player.confidence || 0) >= 70 ? "bg-green-500/20 text-green-400" :
                  (player.confidence || 0) >= 50 ? "bg-yellow-500/20 text-yellow-400" : "bg-red-500/20 text-red-400"
                }`}>
              ...
              <td className="text-center py-3 px-2">
                <span className={`px-2 py-1 rounded text-xs font-semibold ${
                  (player.hit_rate || 0) >= 70 ? "bg-green-500/20 text-green-400" :
                  (player.hit_rate || 0) >= 50 ? "bg-yellow-500/20 text-yellow-400" : "bg-red-500/20 text-red-400"
                }`}>
              ...
              <td className="text-center py-3 px-2">
                <span className={`font-bold font-display text-lg ${
                  player.trend === "up" ? "text-green-400" : player.trend === "down" ? "text-red-400" : "text-muted-foreground"
                }`}>
